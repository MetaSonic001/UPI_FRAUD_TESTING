...
class OptimizedRAGTFDPipeline:
    ...
    def prepare_training_data(self, df):
        """FIXED: Optimized training data preparation without asyncio issues"""
        print(f"Processing {len(df)} transactions with optimized feature extraction...")
        ...
        for batch_idx in range(total_batches):
            ...
            for idx, row in batch_df.iterrows():
                try:
                    ...
                    batch_times.append(50.0)  # Default processing time
        ...
        # Remove constant features and handle edge cases
        try:
            ...
            if len(features_to_keep) > 0:
                ...
                print("Warning: All features are constant, keeping original columns")
        except Exception as e:
